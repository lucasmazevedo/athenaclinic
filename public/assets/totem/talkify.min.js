...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice);
    ...
    var ResponsiveVoice = function () {
            ...
            a.voicecollection = [
                ...
                { name: "Eszter Compact" },
                { name: "hu-HU", rate: 0.4 },
                { name: "Fallback Hungarian", lang: "hu", fallbackvoice: !0 },
                ...
                { name: "Fallback Greek", lang: "el", fallbackvoice: !0 },
                ...
                { name: "Fallback Norwegian", lang: "no", fallbackvoice: !0 },
                { name: "Daniel" },
                { name: "Monica" },
                { name: "Amelie" },
                { name: "Anna" },
                ...
                { name: "Fallback Latin", lang: "la", fallbackvoice: !0 },
                ...
                { name: "Fallback Brazilian Portugese", lang: "pt-BR" },
                { name: "Joana Compact" },
                { name: "Joana" },
                ...
                { name: "Fallback Slovak", lang: "sk", fallbackvoice: !0 },
                { name: "Javier Compact" },
                { name: "Paulina" },
                { name: "es-MX", rate: 0.25 },
                { name: "Fallback Spanish (Latin American)", lang: "es-419", fallbackvoice: !0 },
                                  ...
                                  : (console.log("Voice support NOT ready"),
                                    ...
                                    a.voicesupport_attempts > a.VOICESUPPORT_ATTEMPTLIMIT &&
                                        ...
                                        null != window.speechSynthesis
                                            ? a.iOS
                                                ? (console.log("RV: Voice support ready (cached)"), a.systemVoicesReady(a.cache_ios_voices))
            ...
            a.speak = function (b, c, e) {
                ...
                if (b.length > a.CHARACTER_LIMIT) {
                    for (var d = b; d.length > a.CHARACTER_LIMIT; ) {
                        b = d.search(/[:!?.;]+/);
                        var g = "";
                        if (-1 == b || b >= a.CHARACTER_LIMIT) b = d.search(/[,]+/);
                ...
                for (b = 0; b < f.length; b++)
                    a.fallbackMode
                        ? ((c =
                              ...
                              f[b] +
                              "&tl=" +
                              (d.collectionvoice.lang || d.systemvoice.lang || "en-US") +
                              "&sv=" +
                              (d.collectionvoice.service || d.systemvoice.service || "") +
                              "&vn=" +
                              (d.collectionvoice.voicename || d.systemvoice.voicename || "")),
                          (g = document.createElement("AUDIO")),
                          (g.src = c),
                          (g.playbackRate = a.fallback_playbackrate),
                          (g.preload = "auto"),
                          (g.volume = d.collectionvoice.volume || d.systemvoice.volume || 1),
                          a.fallback_parts.push(g))
                        : ((c = new SpeechSynthesisUtterance()),
                          (c.voice = d.systemvoice),
                          (c.voiceURI = d.systemvoice.voiceURI),
                          (c.volume = d.collectionvoice.volume || d.systemvoice.volume || 1),
                          (c.rate = d.collectionvoice.rate || d.systemvoice.rate || 1),
                          (c.pitch = d.collectionvoice.pitch || d.systemvoice.pitch || 1),
                          (c.text = f[b]),
                          (c.lang = d.collectionvoice.lang || d.systemvoice.lang),
                          (c.rvIndex = b),
                          (c.rvTotal = f.length),
                          0 == b && (c.onstart = a.speech_onstart),
                          (a.msgparameters.onendcalled = !1),
                          null != e
                              ? (b < f.length - 1 && 1 < f.length ? ((c.onend = e.onchunkend), c.addEventListener("end", e.onchuckend)) : ((c.onend = a.speech_onend), c.addEventListener("end", a.speech_onend)),
                                (c.onerror =
                                    e.onerror ||
                                    function (a) {
                                ...
                                (c.onpause = e.onpause),
                                (c.onresume = e.onresume),
                                (c.onmark = e.onmark),
                                (c.onboundary = e.onboundary),
                                (c.pitch = null != e.pitch ? e.pitch : c.pitch),
                                (c.rate = a.iOS ? (null != e.rate ? e.rate * e.rate : 1) * c.rate : (null != e.rate ? e.rate : 1) * c.rate),
                                (c.volume = null != e.volume ? e.volume : c.volume))
                              : ((c.onend = a.speech_onend),
            ...
            a.Dispatch = function (b) {
                if (a.hasOwnProperty(b + "_callbacks") && 0 < a[b + "_callbacks"].length) {
                    b = a[b + "_callbacks"];
