<div class="modal-header">
    <h5 class="modal-title">Alterar Funcionário ({{ 'Id.: ' . $model->id . ' - ' . $model->nome }})</h5>
...
<div class="modal-footer">
    <button type="button" class="btn btn-sm btn-danger" data-bs-dismiss="modal"><i class="fas fa-times me-2"></i>
        Cancelar</button>
    <a data-href="{{ route('funcionarios.alterar', $model->id) }}" id="btnStoreModal" class="btn btn-sm btn-dark"><i
