            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a data-href="{{ route('documentos.cadastrar') }}" id="btnActionModal" class="btn btn-sm btn-dark">
...
@push('js_page')
    ...
    <script src="{{ global_asset('/assets/plugins/custom/tinymce/tinymce.bundle.js') }}"></script>
    <script>
