            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a data-href="{{ route('modalidades.cadastrar') }}" id="btnActionModal" class="btn btn-sm btn-dark">
                    ...
                    <table class="table-row-dashed fs-6 table align-middle" id="coreDatatable">
                        <thead>
                            <tr class="text-muted fw-bold fs-7 gs-2 text-uppercase text-start">
                                <th class="max-w-50px">Cod.</th>
                                <th class="min-w-125px">ABBR</th>
