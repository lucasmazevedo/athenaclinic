            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <select id="tipo" name="tipo" class="form-select">
                        <option selected disabled>Selecione um tipo de sala</option>
                        <option value="0">Guichê</option>
                        <option value="1">Sala de Exame</option>
                        <option value="2">Sala de Consulta</option>
                    </select>
                </div>
            </div>
        </div>
...
<div class="modal-footer">
    <button type="button" class="btn btn-sm btn-danger" data-bs-dismiss="modal"><i class="fas fa-times me-2"></i>
        Cancelar</button>
    <a data-href="{{ route('salas.salvar') }}" id="btnStoreModal" class="btn btn-sm btn-dark"><i
